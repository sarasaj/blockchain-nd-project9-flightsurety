...
var initFund = web3.toWei(11, 'ether');
export default class Contract {
    ...
    this.web3.eth.getAccounts().then(accts => {
            ...
            while(this.airlines.length < 5) {
                ...
                this.flightSuretyData.methods.fund.send({from: this.owner, value:this.initFund});
                this.flightSuretyApp.methods.registerAirline(this.airlines , counter+" Airline" ,{from: this.owner});
                counter++;
            }
